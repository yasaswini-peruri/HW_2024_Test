...
game.redraw = function () {
	...
	game.counter.innerHTML = "A game by vj | Controls: A, D / arrows and SPACE | Points: " + Math.round(-game.player.highestY / (3 * game.options.tileHeight)), game.canvas.width - 50, game.canvas.height - 12
}
